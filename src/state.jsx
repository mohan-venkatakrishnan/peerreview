...
export function AppStateProvider({ children }) {
  ...
  return (
    <AppStateContext.Provider value={{
      ...
      platformStats: USE_MOCK ? { members: 24, products: 31, reviewsExchanged: 128, avgReceived: 4.1, givers: 18, takers: 6, topGivers: [{ name: "Ghost", given: 11, received: 4 }, { name: "Priya K.", given: 8, received: 2 }], watchlist: [{ name: "Wendygo Studio", given: 0, received: 3 }, { name: "Cortex", given: 3, received: 6 }] } : platformStats,
