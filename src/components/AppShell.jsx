...
export default function AppShell() {
  ...
  const { incoming, assigned, plan, account, setSpotlightOpen, setSpotlightQuery } = useAppState();
  const navigate = useNavigate();
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", position: "relative" }}>
      ...
      <aside style={{ width: 232, background: c.surface, borderRight: `1px solid ${c.border}`, padding: "24px 16px", position: "fixed", top: 0, bottom: 0, display: "flex", flexDirection: "column", zIndex: 5 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "0 8px", marginBottom: 20, cursor: "pointer" }} onClick={() => navigate("/")}>
        ...
        <div style={{ borderTop: `1px solid ${c.border}`, padding: "14px 8px 0" }}>
