...
const SECTIONS = [
  ...
  { h: "Email", p: "If you opt in, we may email you about your own activity — when you're assigned a review, when your product receives one, or when your review is verified. These are transactional, tied to your account, and you can turn them off. No marketing blasts." },
